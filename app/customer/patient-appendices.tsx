...
export default function PatientAppendicesScreen() {
  ...
  const handleUpload = () => {
    Alert.alert(
      ...
      "Chức năng upload phụ lục bệnh nhân sẽ được triển khai trong phiên bản tiếp theo.",
      [{ text: "Đóng" }]
    );
  };
        ...
        <View className="flex-row items-center">
          ...
          <View className="flex-1">
            ...
            <Text className="mt-0.5 text-xs text-slate-500">
              Upload và quản lý phụ lục kết quả
            </Text>
          </View>
        </View>
      </View>
      ...
      >
        <View className="flex-1 items-center justify-center py-20">
          ...
          <Text className="text-slate-500 text-sm text-center mb-8 px-4">
            Tính năng này cho phép bạn upload và quản lý phụ lục kết quả xét nghiệm từ file Excel.
